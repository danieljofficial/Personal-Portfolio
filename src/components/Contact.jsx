...
function Contact() {
  ...
  const resumeUrl =
    "https://personal-portfolio-one-lake-29.vercel.app//Daniel-Jonathan-Resume.pdf";
    ...
    <div className="contact">
      ...
      <footer>
        ...
        <div className="contactIcons">
          ...
          <a
            href="https://www.linkedin.com/in/daniel-jonathan-95a935230?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
            target="_blank"
          >
        ...
        <div>
          &copy; {currentYear} <b>Daniel Jonathan</b> all rights reserved.{" "}
        </div>
      </footer>
    </div>
  );
